...
(function () {
  ...
  const SPEAKERS = [
    {
      ...
      photo: "assets/speakers/cecile-chazot.webp",
      photoBody: "assets/speakers/cecile-chazot-body.webp",
      bio: [
    ...
    },
    {
      ...
      photo: "assets/speakers/clarissa-flores.webp",
      photoBody: "assets/speakers/clarissa-flores-body.webp",
      bio: [
    ...
    },
    {
      ...
      photo: "assets/speakers/derek-lee-mcphatter.webp",
      photoBody: "assets/speakers/derek-lee-mcphatter-body.webp",
      bio: [
    ...
    },
    {
      ...
      photo: "assets/speakers/gita-pullapilly.webp",
      photoBody: "assets/speakers/gita-pullapilly-body.webp",
      bio: [
    ...
    },
    {
      ...
      photo: "assets/speakers/jeffery-beckham-jr.webp",
      photoBody: "assets/speakers/jeffery-beckham-jr-body.webp",
      bio: [
    ...
    },
    {
      ...
      photo: "assets/speakers/jessie-fuentes.webp",
      photoBody: "assets/speakers/jessie-fuentes-body.webp",
      bio: [
    ...
    },
    {
      ...
      photo: "assets/speakers/jessica-schleider.webp",
      photoBody: "assets/speakers/jessica-schleider-body.webp",
      bio: [
    ...
    },
    {
      ...
      photo: "assets/speakers/joshua-doss.webp",
      photoBody: "assets/speakers/joshua-doss-body.webp",
      bio: [
    ...
    },
    {
      ...
      photo: "assets/speakers/binkey-tolefree.webp",
      photoBody: "assets/speakers/binkey-tolefree-body.webp",
      bio: [
    ...
    },
    {
      ...
      photo: "assets/speakers/manuela-zoninsein.webp",
      photoBody: "assets/speakers/manuela-zoninsein-body.webp",
      bio: [
    ...
    },
    {
      ...
      photo: "assets/speakers/omar-lateef.webp",
      photoBody: "assets/speakers/omar-lateef-body.webp",
      bio: [
    ...
    },
    {
      ...
      photo: "assets/speakers/pat-tomasulo.webp",
      photoBody: "assets/speakers/pat-tomasulo-body.webp",
      bio: [
    ...
    },
    {
      ...
      photo: "assets/speakers/tamar-gefen.webp",
      photoBody: "assets/speakers/tamar-gefen-body.webp",
      bio: [
    ...
    },
    {
      ...
      photo: "assets/speakers/thackston-lundy.webp",
      photoBody: "assets/speakers/thackston-lundy-body.webp",
      bio: [
    ...
    },
    {
      ...
      photo: "assets/speakers/susan-stokes.webp",
      photoBody: "assets/speakers/susan-stokes-body.webp",
      bio: [
      ...
      <article class="speaker-card${i % 2 ? " alt" : ""}" data-speaker-id="${sp.id}"
        ...
        <div class="speaker-poster">
          ...
          <div class="portrait${sp.photo ? " has-photo" : ""}" aria-hidden="true">
            ${sp.photo
              ? `<img src="${escapeHtml(assetUrl(sp.photo))}" alt="${escapeHtml(sp.name)}, TEDxChicago 2026 speaker" loading="lazy">`
      ...
      <article class="performer-card" data-performer-id="${p.id}"
        ...
        <div class="performer-photo">
          <div class="portrait${p.photo ? " has-photo" : ""}" aria-hidden="true">
            ${p.photo
              ? `<img src="${escapeHtml(assetUrl(p.photo))}" alt="${escapeHtml(p.name)}, TEDxChicago 2026 performer" loading="lazy">`
              : PORTRAIT_PLACEHOLDER}
          </div>
        </div>
  ...
  if (speakerModal) {
    ...
    function openSpeakerModal(speaker, trigger) {
      ...
      /* Prefer the full-body shot; fall back to the headshot for the
         speakers who don't have one, then to the illustrated placeholder. */
      const modalPhoto = speaker.photoBody || speaker.photo;
      modalPortrait.classList.toggle("has-photo", !!modalPhoto);
      modalPortrait.innerHTML = modalPhoto
        ? `<img src="${escapeHtml(assetUrl(modalPhoto))}" alt="${escapeHtml(speaker.name)}">`
        : PORTRAIT_PLACEHOLDER;
